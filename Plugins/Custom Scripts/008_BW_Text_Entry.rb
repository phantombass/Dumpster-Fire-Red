...
#     underline_bitmap.fill_rect(2, 2, 22, 4, Color.new(80, 136, 152))
...
#     textPositions = [
#        [@helptext, 160, 18, false, Color.new(248,248,248),Color.new(72,80,88)]
#     ]
#     chars = @helper.textChars
#     x = 166
#     for ch in chars
#       textPositions.push([ch, x, 54, false, Color.new(248,248,248),Color.new(72,80,88)])
#       x += 24
#     end
